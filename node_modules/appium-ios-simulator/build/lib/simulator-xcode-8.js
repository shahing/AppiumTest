...
class SimulatorXcode8 extends _simulatorXcode2.default {
  ...
  killUIClient(force = false) {
    var _this = this;

    return (0, _asyncToGenerator2.default)(function* () {
      const pid = yield _this.getUIClientPid();
      ...
      try {
        yield (0, _teen_process.exec)('kill', force ? ['-9', pid] : [pid]);
        return true;
      } catch (e) {
  ...
  isAppInstalled(bundleId) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      try {
        const appContainer = yield (0, _nodeSimctl.getAppContainer)(_this2.udid, bundleId, false);
        return appContainer.endsWith('.app');
      } catch (err) {
        try {
          const info = yield (0, _nodeSimctl.appInfo)(_this2.udid, bundleId);
  ...
  waitForBoot(startupTimeout) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      yield (0, _nodeSimctl.startBootMonitor)(_this3.udid, {
        timeout: startupTimeout
      });

      _this3.emit(_simulatorXcode.BOOT_COMPLETED_EVENT);
    })();
  }
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      try {
        yield (0, _asyncbox.waitForCondition)((0, _asyncToGenerator2.default)(function* () {
          try {
            const _ref2 = yield (0, _teen_process.exec)('xcrun', ['simctl', 'launch', _this4.udid, MOBILE_SAFARI_BUNDLE_ID]),
                  stdout = _ref2.stdout;

            if (PROCESS_LAUNCH_OK_PATTERN(MOBILE_SAFARI_BUNDLE_ID).test(stdout)) {
              yield (0, _nodeSimctl.openUrl)(_this4.udid, url);
              return true;
            }
          } catch (err) {
  ...
  cleanSafari(keepPrefs = true) {
    var _this5 = this,
        _superprop_callCleanSafari = (..._args) => super.cleanSafari(..._args);

    return (0, _asyncToGenerator2.default)(function* () {
      try {
        if (yield _this5.isRunning()) {
          yield (0, _nodeSimctl.terminate)(_this5.udid, MOBILE_SAFARI_BUNDLE_ID);
        }
      } catch (ign) {}

      yield _superprop_callCleanSafari(keepPrefs);
    })();
  }

  cleanCustomApp(appFile, appBundleId, scrub = false) {
    var _this6 = this,
        _superprop_callCleanCustomApp = (..._args2) => super.cleanCustomApp(..._args2);

    return (0, _asyncToGenerator2.default)(function* () {
      try {
        yield (0, _nodeSimctl.terminate)(_this6.udid, appBundleId);
      } catch (ign) {}

      yield _superprop_callCleanCustomApp(appFile, appBundleId, scrub);
    })();
  }
  ...
  shake() {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      _logger.default.info(`Performing shake gesture on ${_this7.udid} Simulator`);

      yield (0, _nodeSimctl.spawn)(_this7.udid, ['notifyutil', '-p', 'com.apple.UIKit.SimulatorShake']);
    })();
  }

  _activateWindow() {
    var _this8 = this,
        _superprop_call_activateWindow = (..._args3) => super._activateWindow(..._args3);

    return (0, _asyncToGenerator2.default)(function* () {
      try {
        yield fbsimctl.focus(_this8.udid);
      } catch (err) {
        _logger.default.warn(`Cannot focus Simulator window with fbsimctl. Defaulting to AppleScript. ` + `Original error: ${err.message}`);

        return yield _superprop_call_activateWindow();
      }
    })();
  }
  ...
  isBiometricEnrolled() {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      const output = yield _this9.executeUIClientScript(`
  ...
  enrollBiometric(isEnabled = true) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      yield _this10.executeUIClientScript(`
      tell application "System Events"
        tell process "Simulator"
          set dstMenuItem to menu item "Toggle Enrolled State" of menu 1 of menu item "Touch ID" of menu 1 of menu bar item "Hardware" of menu bar 1
          set isChecked to (value of attribute "AXMenuItemMarkChar" of dstMenuItem) is "✓"
  ...
  sendBiometricMatch(shouldMatch = true) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      yield _this11.executeUIClientScript(`
      tell application "System Events"
        tell process "Simulator"
  ...
  setGeolocation(latitude, longitude) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      try {
        yield fbsimctl.setGeoLocation(_this12.udid, latitude, longitude);
        return true;
      } catch (e) {
        _logger.default.warn(`Cannot set geolocation with fbsimctl. Defaulting to AppleScript. Original error: ${e.message}`);

        const output = yield _this12.executeUIClientScript(`
        tell application "System Events"
          tell process "Simulator"
